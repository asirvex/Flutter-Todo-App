...
/// dialog. Rather than using this widget directly, consider using [CustomDialog]
/// or [SimpleDialog], which implement specific kinds of material design
/// dialogs.
///
/// See also:
///
///  * [CustomDialog], for dialogs that have a message and some buttons.
///  * [SimpleDialog], for dialogs that offer a variety of options.
///  * [viewDialog], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html>
class Dialog extends StatelessWidget {
  /// Creates a dialog.
  ///
  /// Typically used in conjunction with [viewDialog].
  const Dialog({
    Key key,
      ...
      child: MediaQuery.removeViewInsets(
        ...
        child: Center(
          child: ConstrainedBox(
            constraints: const BoxConstraints(minWidth: 380.0),
            child: Material(
...
/// [CustomDialog] tries to size itself using the intrinsic dimensions of its
...
///
/// Typically passed as the child widget to [viewDialog], which displays the
/// dialog.
///
...
///  * [Dialog], on which [CustomDialog] and [SimpleDialog] are based.
///  * [CupertinoCustomDialog], an iOS-styled alert dialog.
///  * [viewDialog], which actually displays the dialog and returns its result.
...
class CustomDialog extends StatelessWidget {
  ...
  /// from [MaterialLocalizations.CustomDialogLabel].
  ///
  /// See also:
  ///
  ...
  @Deprecated(
    ...
    'was introduced to migrate CustomDialog to be scrollable by '
...
///    dialogs, such as [CustomDialog]s.
...
class SimpleDialogOption extends StatelessWidget {
  ...
  /// with a value for [viewDialog] to complete its future with.
...
/// options are represented as an enum. The [viewDialog] method here returns
...
///   switch (await viewDialog<Department>(
///     context: context,
///     builder: (BuildContext context) {
///       return SimpleDialog(
...
///  * [CustomDialog], for dialogs that have a row of buttons below the body.
///  * [Dialog], on which [SimpleDialog] and [CustomDialog] are based.
///  * [viewDialog], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html#simple-dialog>
...
/// `viewDialog` is originally called from. Use a [StatefulBuilder] or a
...
/// See also:
///
///  * [CustomDialog], for dialogs that have a row of buttons below a body.
